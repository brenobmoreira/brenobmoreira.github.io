...
Para trocar a foto: colocar a imagem em `assets/img/` e substituir o placeholder em `index.html` por `<img src="/assets/img/foto.jpg" alt="Breno">`.
Para o PDF do currículo: salvar como `cv/cv.pdf`.
